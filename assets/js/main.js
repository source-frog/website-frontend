function activeToggle(elem) {
  if (elem === "home_link") {
    var element = document.getElementById("home_link");
    element.classList.add("active");
    element = document.getElementById("videos_link");
    element.classList.remove("active");
    element = document.getElementById("download_link");
    element.classList.remove("active");
    element = document.getElementById("about_link");
    element.classList.remove("active");
    element = document.getElementById("contact_link");
    element.classList.remove("active");
  } else if (elem === "videos_link") {
    var element = document.getElementById("home_link");
    element.classList.remove("active");
    element = document.getElementById("videos_link");
    element.classList.add("active");
